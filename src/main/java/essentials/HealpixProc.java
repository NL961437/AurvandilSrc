...
public abstract class HealpixProc extends HealpixBase
  {
  static final HealpixBase[] bn=new HealpixBase[order_max +1],
                             br=new HealpixBase[order_max +1];
  static final double[] mpr =new double[order_max +1],
                        cmpr=new double[order_max +1],
                        smpr=new double[order_max +1];
